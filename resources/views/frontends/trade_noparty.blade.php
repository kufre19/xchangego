...
@endsection
                ...
                <div class="row match-height">
                    <div class="col" style="margin-right: -25px;">
                        <form method="POST" action="{{ route('user.trade.store') }}" class="text-center mt-1"
                            ...
                            <div class="mx-1">
                                <button class="col flex justify-between items-center w-full btn btn-success"
                                    type="submit" id="type" name="type" value="1">
                                    <div class="text-start">Buy</div>
                                    <div class="text-end"> {{ $symbol }}</div>
                                </button>
                                <button
                                    class="col flex justify-between items-center w-full  my-1 btn btn-danger"
    ...
    @else
        <div class="row mr-1">
            <div id="app"></div>
            <div class="flex-end col-2 col-xll-2 col-xl-2 lg:col-span-2 md:col-span-3 xs:col-span-6">
                <div class="card mt-5">
                    <div class="card-body">
                        <div class="">
                            <label for="amount" class="form-label">Your {{ $symbol }} Balance: </label>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="market" aria-labelledby="market-tab" role="tabpanel">
                            <form class="text-center mt-1" enctype="multipart/form-data">
                                ...
                                <div class="mx-1">
                                    <button disabled
                                        class="col flex justify-between items-center w-full btn btn-success"
                                        type="submit" id="type" name="type" value="1">
                                        <div class="text-start">Buy</div>
                                        <div class="text-end"> {{ $symbol }}</div>
                                    </button>
