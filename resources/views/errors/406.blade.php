            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center">
                    <img class="w-50" src="{{ asset('assets/errors/images/error-406.png') }}"
                        alt="{{ __('image') }}">
                    <h2 class="title"><b>406</b> {{ __('license is invalid') }}</h2>
                    <p>{{ __('locale.please contact support.') }} <br> {{ __('on Envato') }}</p>
                    <a href="https://codecanyon.net/user/mashdiv" class="cmn-btn mt-4">{{ __('Contact Us') }}</a>
                </div>
            </div>
        </div>
    </div>
