...
@section('content')
    <div class="row" id="table-hover-row">
        @forelse($templates as $template)
            <div class="col-xl-3 lg:col-span-4 md:col-span-6 xs:col-span-6 col-xs-12">
