    ...
    <div class="bookmark-wrapper d-flex align-items-center">
        <ul class="nav navbar-nav d-xl-none">
            <li class="nav-item"><a class="nav-link menu-toggle" href="javascript:void(0);"><i
                        class="bi bi-list font-medium-5"></i></i></a></li>
        </ul>
    </div>
    <ul class="nav navbar-nav align-items-center ms-auto">
        <li class="nav-item dropdown dropdown-notification me-1">
            <a href="{{ route('user.home') }}"><button class="btn btn-secondary">{{ __('User Dashboard') }}</button></a>
        </li>
        <li class="nav-item dropdown dropdown-notification me-1">
            ...
            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    ...
                    @foreach ($adminNotifications as $notification)
                        <a class="d-flex" href="{{ route('admin.notification.read', $notification->id) }}">
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar">
                                        <img src="{{ getImage(imagePath()['profileImage']['path'] . '/' . @$notification->user->profile_photo_path, imagePath()['profileImage']['size']) }}"
                ...
                <li class="dropdown-menu-footer">
                    <a class="btn btn-primary w-100"
                        href="{{ route('admin.notifications') }}">{{ __('Read all notifications') }}</a>
                </li>
            </ul>
        </li>
