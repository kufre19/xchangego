    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          <button id="toggleSidebar" aria-expanded="false" aria-controls="sidebar" 
            ...
            <NewSvg :class="{ hidden: sidebarPc }"
              ...
              path3="" fill1="currentColor" fill2="" />
            <NewSvg :class="{ hidden: !sidebarPc }"
          ...
          <button id="toggleSidebarMobile" aria-expanded="false" aria-controls="sidebar"
            ...
            <NewSvg :class="{ hidden: sidebarMobile }"
              path1="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
              path3="" fill1="currentColor" fill2="" />
            <NewSvg id="toggleSidebarMobileClose" :class="{ hidden: !sidebarMobile }"
              path1="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
              path3="" fill1="currentColor" fill2="" />
          </button>
        ...
        <div class="flex items-center lg:order-2">
          <a v-if="userStore.role == 1" href="/admin/dashboard" class="btn btn-outline-secondary mr-2">
            {{ $t("Admin") }}
          </a>
          <template v-if="ext.walletConnect === 1">
            <Login class="mx-3" />
          </template>
          <DarkMode @change-theme="changeTheme" v-if="plat.system.dark_light_mode_change" />
