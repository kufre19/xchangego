    ...
    <div class="chat-application">
        <section class="chat-app-window">
            <div class="active-chat">
                <div class="user-chats" :key="ticket.unread">
                    <div
                        class="chats"
                    ...
                    >
                        <div
                            class="chat"
                            :class="message.side == 1 ? 'chat-left' : ''"
                        >
                ...
                <form
                    class="chat-app-form"
                    method="POST"
                    :action="'/user/support/ticket/reply/' + ticket.id"
                >
                    <div
...
export default {
    ...
    methods: {
        ...
        fetchData() {
            this.$http
                .post("/user/fetch/support/ticket/" + this.$route.params.id)
                .then((response) => {
