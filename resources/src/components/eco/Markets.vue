                        ...
                        <tr v-for="(eco, index) in ecos" :key="index">
                            <td>
                                <div class="d-flex justify-content-start">
                                    ...
                                    <router-link
                                        :to="
                                            './' + eco.currency + '-' + eco.pair
                                        "
                                    >
                                        <span class="text-dark fw-bold">{{
                                            eco.currency.includes("_")
                                                ? eco.currency.substring(
                                                      0,
                                                      eco.currency.indexOf("_")
                                                  )
                                                : eco.currency
                                        }}</span
                                        ><span
                                            v-if="eco.currency.includes('_')"
                                            class="badge bg-info"
                                            >{{
                                                eco.currency.substring(
                                                    eco.currency.indexOf("_") +
                                        ...
                                        ><span
                                            v-if="eco.pair.includes('_')"
                                            class="badge bg-info"
                                            >{{
                                                eco.pair.substring(
                                                    eco.pair.indexOf("_") + 1
                                                )
                                            }}</span
                                        >
                                    </router-link>
                            ...
                            <td class="d-lg-none d-xl-block">
                                <span
                                    :class="'change-' + eco.currency + eco.pair"
                                ></span>
                            </td>
                            <td>
                                <span
                                    :class="'tic-' + eco.currency + eco.pair"
                                ></span
                                ><i
                                    :class="
                                        'tic-' +
...
<script>
import MarketList from "../trading/MarketsList.vue";
// component
export default {
    // component list=
