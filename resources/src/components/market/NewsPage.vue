<template>
    ...
    >
                ...
                <div class="flex-row flex-middle flex-space">
                    ...
                    <div class="text-nowrap">
                        <Dropdown>
                            <button
                                slot="trigger"
                                class="form-btn bg-primary-hover bi bi-chevron-down iconLeft"
                            >
                                {{ filterLabel }}
                            </button>
                            <div slot="list">
                                <div
                                    class="flex-row flex-top flex-space px-1 mb-1"
                                >
                                    <div
                                        class="flex-1 me-1 form-label bi bi-twitter iconLeft"
                                    >
                                        Twitter Accounts ({{
                                            accountsList.length
                                        }})
                                    ...
                                    <button
                                        v-if="searchHandle"
                                        class="text-bright-hover bi bi-list iconLeft"
                                        @click="searchHandle = ''"
                                    >
                                        Show all
                                    </button>
                                ...
                                <div class="tablelist-wrap mb-1">
                                    <div class="tablelist-content">
                                        <div
                                            ...
                                            v-for="a in accountsList"
                                            :key="a.handle"
                                        >
                                            <div
                                                class="flex-1 text-bright-hover text-clip clickable me-1"
                                                @click="
                                                    applyFilters('', a.handle)
                                                "
                                            >
                                                <span
                                                    class="text-info bi bi-twitter"
                                                ></span>
                                                <span
                                                    class="text-clip"
                                                    :class="{
                                                        'text-gain': a.active,
                                                        'text-danger text-striked':
                                                            a.error,
                                                    }"
                                                    :title="a.name"
                                                    v-tooltip
                                            ...
                                            <div class="me-1">
                                                <span
                                                    ...
                                                    title="Fetch"
                                                    @click="
                                                        fetchByHandle(a.handle)
                                                    "
                                                    v-tooltip
                                                >
                                                    <span
                                                        v-if="a.fetching"
                                                        class="text-badge text-primary"
                                                        >...</span
                                                    >
                                                    <span
                                                        v-else
                                ...
                                <form
                                    class="twitter-accounts-form px-1 mb-1"
                                    action="#"
                                    autocomplete="off"
                                    @submit.prevent="accountFormHandler"
                                >
                                    <div class="form-input text-nowrap">
                                        <div
                                            class="bi bi-twitter iconLeft"
                                        ></div>
                                        <input
                                            class="flex-1"
                                            type="text"
                                        ...
                                        />
                                        <button
                                            class="bi bi-plus-lg text-primary-hover"
                                            type="submit"
                                        ></button>
                                    </div>
                                </form>
                                ...
                                <div class="text-nowrap px-1">
                                    <button
                                        class="bi bi-plus-lg iconLeft text-bright-hover"
                                    ...
                                    <button
                                        class="bi bi-save iconLeft text-bright-hover"
                        ...
                        <Dropdown>
                            <button
                                slot="trigger"
                                class="form-btn bg-primary-hover bi bi-gear"
                            ></button>
                            <div slot="list" class="px-1">
                                <div class="mb-1">
                                    <div class="form-label mb-1 push-small">
                                        News &amp; Notifications Options
                                    </div>
                                    <Toggle
                                        :text="'Auto re-fetch latest news'"
                                        v-model="options.news.enabled"
                                        @change="saveOptions"
                                    ></Toggle>
                                    <Toggle
                                        :text="'Notify when news is available'"
                                        v-model="options.news.notify"
                                        @change="saveOptions"
                                    ></Toggle>
                                    <Toggle
                                        :text="'E-mail news notifications'"
                                ...
                                <div class="mb-1">
                                    <div class="form-label mb-1 push-small">
                                        How often to send fetch requests
                                    </div>
                                    <div
                                        class="flex-row flex-middle flex-stretch"
                                    >
                                        <input
                                            class="flex-1 me-1"
                                            type="range"
                                            ...
                                            max="60"
                                            step="1"
                                            v-model="options.news.interval"
                                            @change="saveOptions"
                                        />
                                        <span class="text-bright">{{
                                            options.news.interval
                                                | toNoun("sec", "secs")
                                        }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1">
                                    <div class="form-label mb-1 push-small">
                                        Delay re-fetching from same source
                                    </div>
                                    <div
                                        class="flex-row flex-middle flex-stretch"
                                    >
                                ...
                                <div class="mb-1">
                                    <div class="form-label mb-1 push-small">
                                        Tweets to fetch from each source
                                    </div>
                                    <div
                                        class="flex-row flex-middle flex-stretch"
                                    >
                                ...
                                <div class="mb-1">
                                    <div class="form-label mb-1 push-small">
                                        Total number of tweets to store
                                    </div>
                                    <div
                                        class="flex-row flex-middle flex-stretch"
                                    >
                ...
                <div class="card tablelist-wrap">
                    ...
                    <div class="tablelist-header">
                        <div class="flex-row flex-middle flex-stretch">
                            ...
                            <div
                                class="tablelist-10 text-nowrap text-end me-1 if-small"
                            >
                                <span
                                    class="clickable"
                                    @click="
                            ...
                            <div
                                class="tablelist-30 text-nowrap text-grey me-1 if-medium"
                            >
                                <span
                                    class="clickable"
                                    @click="
                            ...
                            <div
                                class="tablelist-10 text-nowrap text-grey text-end"
                            >
                                Details
                            </div>
                        </div>
                    ...
                    <div
                        class="tablelist-content py-1 text-center text-info"
                        v-if="!chartData.length"
                    >
                        <div class="bi bi-graph-up iconLarge"></div>
                        <div>
                            Sentiment analysis data for each token based on
                            loaded tweets.
                        </div>
                    ...
                    <div class="tablelist-content" v-if="chartData.length">
                        <div
                            class="tablelist-row flex-row flex-middle flex-stretch"
                            v-for="d in chartList"
                            :key="d.token"
                        >
                            <div
                                class="tablelist-20 text-clip text-primary me-1"
                            >
                                <button
                                    title="Search"
                                    @click="applyFilters(d.search, '')"
                                    v-tooltip
                                >
                            ...
                            <div
                                class="tablelist-10 text-clip text-secondary me-1 if-small"
                            >
                                {{ d.token }}
                            </div>
                            <div
                            ...
                            <div
                                class="tablelist-30 text-nowrap me-1 if-medium"
                            >
                                <div v-if="d.barPercent" class="percent-bar">
                                    <div
                                        :class="d.barColor"
                                        :style="{ width: d.barPercent + '%' }"
                                    ></div>
                                </div>
                            </div>
                            <div
                                class="tablelist-20 text-nowrap me-1"
                                :class="d.styles"
                                v-html="d.sentiment"
                            ></div>
                            <div class="tablelist-10 text-nowrap text-end">
                                <router-link
                                    v-if="d.route"
                                    class="bi bi-graph-up iconLeft text-btn bg-info-hover"
                                    :to="d.route"
                                    >Info</router-link
                                >
                            </div>
                    ...
                    <div class="tablelist-header">
                        <div
                            class="newspage-chart-row flex-row flex-middle flex-stretch text-grey"
                        >
                            <div class="flex-1 text-clip">
                                Sentiment analysis for
                                {{
                                    chartData.length | toNoun("token", "tokens")
                                }}
                                found in all available tweets.
                            </div>
                            <div class="text-end">
                                <button
                                    class="bi bi-x-lg iconLeft text-danger-hover"
                                    @click="flushTweets()"
                                >
                                    Flush Data
                                </button>
        ...
        <section class="mb-1" v-if="!tweetsList.length">
            <div class="container">
                <div class="card p-1 flex-row flex-middle flex-stretch">
                    <div
                        class="bi bi-info-circle iconLarge text-grey me-1"
                    ></div>
                    <div class="flex-1">
                        <div v-if="searchStr">
                            <h3 class="text-bright">
                                No Match For
                            ...
                            <span class="text-grey"
                                >Can't find anything matching your search
                                input.</span
                            >
                        </div>
                        <div v-else-if="searchHandle">
                            <h3 class="text-bright">
                                ...
                                <a
                                    ...
                                    :href="
                                        'https://twitter.com/' + searchHandle
                                    "
                                    target="_blank"
                                    >{{ filterLabel }}</a
                                >
                            ...
                            <span class="text-grey"
                                >There are no entries available for the selected
                                news source.</span
                            >
                        </div>
                        <div v-else>
                            ...
                            <span class="text-grey"
                                >News data from remote sources has not loaded
                                yet.</span
                            >
                        </div>
                    </div>
        ...
        <section class="pagelist-wrap" id="newspage-list">
            <div class="container">
                <div
                    class="pagelist-item flex-row flex-top flex-stretch"
                    v-for="t in tweetsList"
                    :key="t.id"
                >
                    ...
                    <div class="flex-1">
                        <div class="flex-row flex-space mb-1">
                            <h3
                                class="text-clip clickable"
                                @click="
                                    openLink('https://twitter.com/' + t.handle)
                                "
                            >
                                <span class="text-primary-hover">{{
                                    t.name
                                }}</span>
                                <small class="text-smaller text-grey-hover"
                                    >@{{ t.handle }}</small
                                >
                            </h3>
    ...
    computed: {
        ...
        accountsList() {
            let list = this.newsHandlers.map((tw) => {
                let { uid, handle, name, avatar, url, last, fetching, error } =
                    tw.getData();
                let active = handle === this.searchHandle;
                let count = this.newsEntries.filter(
                    (t) => t.handle === handle
                ).length;
                return {
                    uid,
        ...
        filterLabel() {
            ...
            let t = this.newsHandlers
                .filter((tw) => tw.handle === this.searchHandle)
                .shift();
    ...
    methods: {
        ...
        importAccounts() {
            files.importData((accounts) => {
                ...
                this.$bus.emit(
                    "showNotice",
                    "Imported " + saved + "/" + total + " twitter accounts.",
                    "success"
                );
            });
        },
        ...
        fetchByHandle(handle) {
            if (this.$news.fetchByHandle(handle)) {
                this.$bus.emit(
                    "showNotice",
                    "Fetching latest tweets from @" + handle + "...",
                    "success"
                );
            }
        },
        ...
        flushTweets() {
            ...
            this.$bus.emit(
                "showNotice",
                "All news entries have been deleted.",
                "success"
            );
        },
        ...
        accountFormHandler(e) {
            ...
            let handle = String(e.target.handle.value || "")
                .replace(/[^\w]+/g, "")
                .trim();
            if (!handle)
            ...
            if (added) {
                this.$bus.emit(
                    "showNotice",
                    "Started tracking tweets from @" + handle + ".",
                    "success"
                );
            } else {
                this.$bus.emit(
                    "showNotice",
                    "Could not add account @" + handle + ".",
                    "warning"
                );
            }
        ...
        removeTwitterHandler(handle) {
            ...
            if (removed) {
                this.$bus.emit(
                    "showNotice",
                    "Stopped tracking tweets from @" + handle + ".",
                    "success"
                );
            } else {
                this.$bus.emit(
                    "showNotice",
                    "Could not remove account @" + handle + ".",
                    "warning"
                );
            }
