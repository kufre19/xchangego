                        ...
                        <div class="col-6">
                            ...
                            >
                                <input
                                    ...
                                    :key="practice_balance"
                                    :value="practice_balance"
                                    readonly
                                    aria-label="Amount (to the nearest dollar)"
                                />
                                <span
...
export default {
    ...
    data() {
        return {
            ...
            amount: null,
            wallet: null,
            practice_balance: this.user.practice_balance,
            obj: [],
    ...
    methods: {
        ...
        Order() {
            ...
            if (this.type == "practice") {
                if (this.user.practice_balance - this.amount < 0) {
                    this.$toast.error(
        ...
        gameResult() {
            this.$http
                ...
                .then((response) => {
                    ...
                    if (this.type == "practice") {
                        this.practice_balance = response.data.balance;
                    } else if (this.type == "trade") {
