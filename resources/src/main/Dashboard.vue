<template>
  <div class="mb-4">
    <div class="flex justify-between p-4">
      <div>
        ...
        <span>{{ lockedBalance }}</span> <!-- Dynamically display locked balance -->
      </div>
      <div>
        <span class="font-medium">{{ $t("Available Balance:") }}</span>
        <span>{{ availableBalance }}</span> <!-- Dynamically display available balance -->
      </div>
    </div>
  </div>
      ...
      >
        ...
        >
          <div class="flex">
            ...
            <span class="mr-2">{{ $t("Spot Market") }}</span>
          </div>
        </button>
      </li>
      <li
  ...
  >
    ...
    <VTPagination
      v-model:currentPage="currentPageMainVolume"
      class="float-right flex items-center justify-between pt-4"
      aria-label="Table navigation"
      :total-pages="totalPagesMainVolume"
      :max-page-links="3"
      :boundary-links="true"
    >
      <template #firstPage> {{ $t("First") }} </template>
