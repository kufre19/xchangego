...
class Tatum
{
    use Base,
        ...
        BitcoinBlockchain,
        EthereumBlockchain,
        BinanceSmartChainBlockchain,
        BinanceBeaconChainBlockchain,
        EthereumTransaction,
        BcashBlockchain,
        LitecoinBlockchain,
        Wallet,
    ...
    public function __construct()
    {
        ...
        $this->VETUrl = VET_URL;
        $this->supportedBlockchain = [
            'BTC', 'BSC', 'DOGE', 'SOL', 'TRON', 'ALGO', 'MATIC', 'CELO', 'KLAY', 'ETH', 'BCH', 'LTC', 'XRP', 'XLM', 'BNB',
    ...
    {
        //if (getenv('TATUM_API_KEY') === false || getenv('TATUM_API_KEY') === null || !getenv('TATUM_API_KEY') || getenv('TATUM_API_KEY') == '') {
        ...
        if (Base::in_arrayi($coin, $this->supportedBlockchain)) {
            if ($this->network === 'mainnet') {
                if ($coin === 'BTC') {
                    ...
                    return BSC_DERIVATION_PATH;
                } else if ($coin === 'TRON') {
                    return TRON_DERIVATION_PATH;
                } else if ($coin === 'BCH') {
